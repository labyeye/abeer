          ...
          {navItems.map((item, idx) =>
            item.dropdown ? (
              <div className="relative group" key={idx}>
                ...
                <div className="absolute top-full left-0 mt-2 w-72 bg-white text-gray-900 rounded-lg shadow-xl border border-gray-200 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-300 z-50">
                  <div className="p-4">
                    {item.dropdown.map((category, subIdx) => (
                      ...
                      >
                        <div className="flex items-center justify-between p-2 hover:bg-gray-100 rounded cursor-pointer">
                          <h4 className="text-sm font-semibold group-hover/sub:text-white">
                            {category.category}
                          </h4>
                          <svg
