...
const LiveStreamBannerManager = () => {
  const [banners, setBanners] = useState<LiveStreamBanner[]>([]);
  ...
  const handleEdit = (banner: LiveStreamBanner) => {
    setFormData({
      title: banner.title,
...
export default LiveStreamBannerManager;
