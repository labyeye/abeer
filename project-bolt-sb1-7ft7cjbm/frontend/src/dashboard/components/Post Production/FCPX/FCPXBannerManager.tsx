...
const FCPXBannerManager = () => {
  const [banners, setBanners] = useState<FCPXBanner[]>([]);
  ...
  const handleEdit = (banner: FCPXBanner) => {
    setFormData({
      title: banner.title,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">FCPX Banner Manager</h1>
        <button
          onClick={() => {
            localStorage.removeItem("authToken");
            setAuthToken("");
...
export default FCPXBannerManager;
