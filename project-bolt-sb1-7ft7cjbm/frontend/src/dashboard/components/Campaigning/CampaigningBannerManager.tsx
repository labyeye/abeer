...
const CampaigningBannerManager = () => {
  const [banners, setBanners] = useState<CampaigningBanner[]>([]);
  ...
  const handleEdit = (banner: CampaigningBanner) => {
    setFormData({
      title: banner.title,
...
export default CampaigningBannerManager;
