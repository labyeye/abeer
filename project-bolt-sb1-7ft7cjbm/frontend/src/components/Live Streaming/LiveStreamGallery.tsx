      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {galleryItems.filter(item => item.isFeatured).map((item) => (
            <div 
              key={item._id} 
              className="bg-white rounded-lg overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-pointer"
            ...
            >
              <div className="relative">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                  ...
                  <p className="text-white text-sm md:text-base">{item.place}</p>
