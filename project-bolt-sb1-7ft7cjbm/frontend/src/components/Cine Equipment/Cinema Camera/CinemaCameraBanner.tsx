...
interface CinemaCameraBannerData {
  title: string;
  description: string;
  backgroundImageUrl: string;
}

const CinemaCameraBanner = () => {
  const [banner, setBanner] = useState<CinemaCameraBannerData | null>(null);
...
export default CinemaCameraBanner;
