...
interface EducationalBannerData {
  title: string;
  description: string;
...
const EducationalBanner = () => {
  const [banner, setBanner] = useState<EducationalBannerData | null>(null);
    ...
    const fetchBanner = async () => {
      try {
        const response = await axios.get(
          "https://abeer.onrender.com/api/audio-educational-banner/active"
        );
