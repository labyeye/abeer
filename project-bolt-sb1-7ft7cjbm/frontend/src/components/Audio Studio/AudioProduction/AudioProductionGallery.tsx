    ...
    const fetchGalleryItems = async () => {
      try {
        const response = await axios.get(
          "https://abeer.onrender.com/api/audio-production-gallery"
        );
    ...
    <section className="py-20 relative min-h-screen">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <h2 className="text-3xl md:text-4xl font-bold text-[#263f49] mb-12 text-center">
          Our Audio Produciton & Recording Services
        </h2>
...
export default AudioProductionGallery;
